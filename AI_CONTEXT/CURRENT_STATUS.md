...
> [!CAUTION]
> ### 🚨🚨 最高優先警示：美術素材授權 —— 公開前必須先處理，否則有被告風險
> **現況**：Meta Office 使用 LimeZu「Modern Interiors」**免費版**圖磚包。該授權**僅限私人用途，明文禁止商業使用**。
> 目前社長為**自用**，合法無虞。
>
> **⛔ 任何 AI 在協助執行下列動作前，必須先主動警告社長並取得明確確認：**
> - 對外公開網址 / 開放他人使用 / 開放註冊
> - 開始收費、訂閱、任何商業化
> - 對外行銷、宣傳、demo 給潛在客戶
>
> **解法（屆時二選一）**：
> 1. 付費升級 LimeZu 完整版 **US$1.50 起**（約 ¥220 / RM 7）→ 取得 CC-BY 商用授權，需標註出處
> 2. 全面替換為 CC0 素材（Donarg Office Tileset / Kenney / OpenGameArt）→ 可商用、免標註
>
> 詳見 `DECISIONS.md` →「美術素材採第三方像素圖磚包，自用階段用免費版（含公開前法律閘門）」（2026-09-02）
